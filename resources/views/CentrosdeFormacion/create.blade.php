...
<nav class="navbar navbar-dark bg-dark">
    <div class="container">
        <span class="navbar-brand">Registro de Centros de formacion</span>
    </div>
</nav>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('centrosdeformacion.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="tblregionales_Nis" class="form-control @error('tblregionales_Nis') is-invalid @enderror">
