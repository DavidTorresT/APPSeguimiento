                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('eps.destroy', $Eps->Nis) }}"
                                      method="POST"
                                      class="form-eliminar d-inline" data-nis="{{ $Eps->Nis }} "
                                      data-numDoc="{{$Eps->Numdoc}}" data-denominacion="{{$Eps->Denominacion}}">
                                    @csrf
                                    @method('DELETE')
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script><script>
    document.querySelectorAll('.form-eliminar').forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            Swal.fire({
                title: '¿Estás seguro de eliminar esta eps?',
                text: `Nis: ${nis} |,Numero de documento: ${numdoc} |, Denominacion: ${denominacion}`,
                icon: 'warning',
