...
<div class="container mt-4"><div class="d-flex justify-content-between mb-3">
        <h3>Lista de programas de formacion</h3>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('programas.destroy', $programas->Nis) }}"
                                      method="POST"
                                      class="form-eliminar d-inline" data-nis="{{ $programas->Nis }} "
                                      data-codigo="{{$programas->Codigo}}" data-denominacion="{{$programas->Denominacion}}">
                                    @csrf
                                    @method('DELETE')
