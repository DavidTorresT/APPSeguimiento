                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('instructores.destroy', $instructor->Nis) }}"
                                      method="POST"
                                      class="form-eliminar d-inline" data-numDoc="{{ $instructor->NumDoc }} "
                                      data-nombres="{{$instructor->Nombres}}" data-apellidos="{{$instructor->Apellidos}}">
                                    @csrf
                                    @method('DELETE')
...
@if(session('actualizar'))
    <script>
        Swal.fire({
            title: '¡Instructor actualizado correctamente!',
